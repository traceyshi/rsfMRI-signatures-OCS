...
```{r}
library(R.matlab)
connmats_raw_discovery <- readMat(paste(workdir, '/data/cf_mat_raw_discovery.mat', sep = ""))
...
save.image(paste(workdir, '/FINAL/discovery/data/Data_prep/discovery_raw_data.RData', sep=""))

#save discovery subject ID list
write.csv(subjectkey_discovery,file=paste(workdir, '/FINAL/discovery/data/Data_prep/subjectkey_discovery.csv', sep=""),row.names=F)
```
...
## Save raw clinical, rs-FC, and covariates data
```{r eval=FALSE, include=FALSE}
save.image(paste(workdir, '/FINAL/discovery/data/Data_prep/discovery_features_data.RData', sep = "")
...
```{r}
write.csv(clin_features_scaled, paste(workdir, '/FINAL/discovery/data/clin_features_scaled.csv', sep = ""), row.names = FALSE, col.names = FALSE)
write.csv(rsFC_features_scaled, paste(workdir, '/FINAL/discovery/data/rsFC_features_scaled.csv', sep = ""), row.names = FALSE, col.names = FALSE)
...
write.csv(partitions2$Fold01.Rep1, paste(workdir, '/FINAL/discovery/data/partitions2_rep01fold1.csv', sep = ""), row.names = FALSE, col.names = FALSE)
write.csv(partitions2$Fold02.Rep1, paste(workdir, '/FINAL/discovery/data/partitions2_rep01fold2.csv', sep = ""), row.names = FALSE, col.names = FALSE)
write.csv(partitions2$Fold03.Rep1, paste(workdir, '/FINAL/discovery/data/partitions2_rep01fold3.csv', sep = ""), row.names = FALSE, col.names = FALSE)
write.csv(partitions2$Fold04.Rep1, paste(workdir, '/FINAL/discovery/data/partitions2_rep01fold4.csv', sep = ""), row.names = FALSE, col.names = FALSE)
write.csv(partitions2$Fold05.Rep1, paste(workdir, '/FINAL/discovery/data/partitions2_rep01fold5.csv', sep = ""), row.names = FALSE, col.names = FALSE)
write.csv(partitions2$Fold06.Rep1, paste(workdir, '/FINAL/discovery/data/partitions2_rep01fold6.csv', sep = ""), row.names = FALSE, col.names = FALSE)
write.csv(partitions2$Fold07.Rep1, paste(workdir, '/FINAL/discovery/data/partitions2_rep01fold7.csv', sep = ""), row.names = FALSE, col.names = FALSE)
write.csv(partitions2$Fold08.Rep1, paste(workdir, '/FINAL/discovery/data/partitions2_rep01fold8.csv', sep = ""), row.names = FALSE, col.names = FALSE)
write.csv(partitions2$Fold09.Rep1, paste(workdir, '/FINAL/discovery/data/partitions2_rep01fold9.csv', sep = ""), row.names = FALSE, col.names = FALSE)
write.csv(partitions2$Fold10.Rep1, paste(workdir, '/FINAL/discovery/data/partitions2_rep01fold10.csv', sep = ""), row.names = FALSE, col.names = FALSE)
